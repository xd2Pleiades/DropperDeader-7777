...
def generate_dob(
    ...
    :param max_age: oldest allowed age (inclusive)
    :param as_of: reference date to calculate age from; defaults to today
    ...
    as_of = as_of or date.today()  # was date.now() — that's a datetime method, not date
